...
CREATE OR REPLACE PACKAGE STORESTAFF_CTX_PKG AUTHID CURRENT_USER IS
...
CREATE OR REPLACE PACKAGE BODY STORESTAFF_CTX_PKG IS
    -- Define a procedure to set the store staff context
    ...
    BEGIN
        ...
        -- Set the retrieved values in the storestaff_ctx context
